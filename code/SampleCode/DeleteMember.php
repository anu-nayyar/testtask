...
<html>
	...
	<body>
		<p><Strong>MailChimp Member Deletion</Strong></p>
		...
		<form method="POST" enctype="application/x-www-form-urlencoded">
			<table>
				<tbody>
					...
					<tr>
						<td>&nbsp;</td>
						<td><input type="submit" value="Delete Existing Member"></td>
					</tr>
				</tbody>
			</table>
		</form>
...
<?php
	...
	if (!empty($_POST)) {
		...
		if($mailChimpValidate) {
			...
			//Call delete Member Function.
			$mailChimpMemberID = $mailChimpObj->deleteExistingMember('',$_POST['id'],$_POST['member_id']);

			if($mailChimpMemberID) {
				echo "<div class='msgbox success'>Member has been successfully deleted from the list with ID: ".$mailChimpMemberID."</div>";
			}
