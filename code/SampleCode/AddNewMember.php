...
<html>
	...
	<body>
		<p><Strong>MailChimp Add New Member</Strong></p>
		<p>Please provide the following details for New Member addition</p>
		<form method="POST" enctype="application/x-www-form-urlencoded">
			<table>
				<tbody>
					...
					<tr>
						<td>&nbsp;</td>
						<td><input type="submit" value="Add New Member"></td>
					</tr>
				</tbody>
			</table>
		</form>
...
<?php
	...
	if (!empty($_POST)) {
		...
		if($mailChimpValidate) {
			...
			//Call add New Member Function.
			$mailChimpMemberID = $mailChimpObj->addNewMember($transaction,$_POST['id']);

			if($mailChimpMemberID) {
				echo "<div class='msgbox success'>New Member has successfully added into the list with id: ".$mailChimpMemberID."</div>";
			}
